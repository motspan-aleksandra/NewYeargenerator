...
let poems = [
    ...
    },
    {
        ...
        bg: `background-image: url(../img/annie-spratt-Z9Ds4w141i4-unsplash.jpg);`
    }
]
...
btn.addEventListener('click', function () {
    ...
    /*document.getElementsById("wrapperr").style.content = poems[randomIndex].bg;*/
    document.getElementById("cat-img").style.content = cat;
    //document.getElementById("wrapperr").style.background = poems[randomIndex].bg;
    document.querySelector("#wrapper") = poems[randomIndex].bg;
})
